package com.dante.knowledge.utils.choice_city;
...
public class ChoiceCityActivity extends Activity implements OnScrollListener {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // ��λ
				...
				if (locateProcess == 1) {
					...
					locateHint.setText("最近访问城市");
					city.setVisibility(View.VISIBLE);
					city.setText(currentCity);
					mLocationClient.stop();
					pbLocate.setVisibility(View.GONE);
				} else if (locateProcess == 3) {
					locateHint.setText("热门城市");
					city.setVisibility(View.VISIBLE);
					city.setText("武汉");
					pbLocate.setVisibility(View.GONE);
				}
