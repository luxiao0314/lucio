...
import com.dante.knowledge.mime.presenter.fragment.WbHomeFragment;
import com.dante.knowledge.mime.presenter.fragment.WbSearchFragment;
import com.dante.knowledge.mime.presenter.fragment.WbWeatherFragment;
...
public class TabsFragment extends BaseFragment {
    ...
    public static final String MENU_WEIBO = "weibo";
    ...
    protected void initViews() {
        ...
        tabs.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabReselected(TabLayout.Tab tab) {
                if (!MENU_WEIBO.equals(menuType) && tab.getPosition() == 2) {
                    scrollToTop(((RecyclerFragment)fragments.get(tab.getPosition())).getRecyclerView());
                }
            }
        });
    }
    ...
    private void initFragments() {
        ...
        } else if (MENU_WEIBO.equals(menuType)) {
            String [] titles = new String[]{getString(R.string.weibo_home),getString(R.string.weibo_search),getString(R.string.weibo_weather)};
            mTitles = Arrays.asList(titles);
            fragments.add(new WbHomeFragment());
            fragments.add(new WbSearchFragment());
            fragments.add(new WbWeatherFragment());
        } else {
