package com.dante.knowledge.mime.utils;
...
public class RetrofitService {
    ...
    private static void initOkHttpClient() {
        if (mOkHttpClient == null) {
            ...
            File cacheFile = new File(KnowledgeApp.getContext().getCacheDir(),
                    "HttpCache"); // 指定缓存路径
            ...
            Interceptor rewriteCacheControlInterceptor = new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    ...
                    if (!NetUtil.isConnected(KnowledgeApp.getContext())) {
...
//                            .connectTimeout(30, TimeUnit.SECONDS).build();
    ...
    public static String getCacheControl() {
        return NetUtil.isConnected(KnowledgeApp.getContext()) ? CACHE_CONTROL_NETWORK : CACHE_CONTROL_CACHE;
    }
}
